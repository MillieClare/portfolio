...
const testimonials = [
  {
    testimonial:
      "I came to Millie with a very clear design idea that I just didn't know how to replicate on the screen! She was completely faithful to my vision and was always happy to tweak things, no matter how small my request.",
    name: "Lucia D'Avanzo-Lewis",
  ...
  // {
  //   testimonial:
  //     "I've never met a web developer who truly cares about their clients' success like Millie does.",
  //   name: "Chris Brown",
  //   designation: "COO",
  //   company: "DEF Corp",
